...
public class EventgamesController {
	...
	public String addContact(@ModelAttribute("eventgames") Eventgames eventgames, BindingResult result) {
		eventgamesService.addEventgames(eventgames);
		return "redirect:/table_pages/eventgames";
	}

	@RequestMapping("/table_pages/eventgames/delete/{idGame}/deleteEventgames.html")
