		...
		<div id="content">
			<div id="dataBlock">
				<form:form action="${pageContext.request.contextPath}/pages/events/editgame" method="post" modelAttribute="eventgame">
					...
					<div style="padding: 5px 20px 0px 20px;"><div class="usr_tmplt_txt_l">Контакты организатора:</div><div class="usr_tmplt_txt_r"> tel:${phone}  </a> </div><div class="usr_tmplt_txt_clr"></div></div> 
				...
				<div class="usr_tmplt_txt" style="width:100%; background-color: #EEEFE3; border:2px solid grey;">
					<form:input path="idgame" type="hidden" value="${eventgame.idgame}" />
						<div style="padding: 5px 20px 0px 20px;"><div class="usr_tmplt_txt_l" style="width:30%">Время начала:</div><div class="usr_tmplt_txt_r"><form:input type="text" path="starttime"  class="inputText" /></div><div class="usr_tmplt_txt_clr"></div></div>
						<div style="padding: 5px 20px 0px 20px;"><div class="usr_tmplt_txt_l" style="width:30%">Время окончания:</div><div class="usr_tmplt_txt_r"><form:input type="text" path="endtime"  class="inputText" /></div><div class="usr_tmplt_txt_clr"></div></div>
