		...
		<div id="content">
			<div id="dataBlock">
				...
				<div class="usr_tmplt_txt" style="width:100%; margin-bottom:10px;">
					<div style="padding: 5px 20px 0px 20px;"><div class="usr_tmplt_txt_l" style="width:30%">Id игры:</div><div class="usr_tmplt_txt_r">${game.idgame}</div><div class="usr_tmplt_txt_clr"></div></div>
					<div style="padding: 5px 20px 0px 20px;"><div class="usr_tmplt_txt_l" style="width:30%">Время начала:</div><div class="usr_tmplt_txt_r">${game.starttime}</div><div class="usr_tmplt_txt_clr"></div></div>
					<div style="padding: 5px 20px 0px 20px;"><div class="usr_tmplt_txt_l" style="width:30%">Время окончания:</div><div class="usr_tmplt_txt_r">${game.endtime}</div><div class="usr_tmplt_txt_clr"></div></div>
					...
					<div style="padding: 5px 20px 0px 20px;"><div class="usr_tmplt_txt_l" style="width:30%">Комментарии:</div><div class="usr_tmplt_txt_r">${game.comments}</div><div class="usr_tmplt_txt_clr"></div></div>
					...
					<div style="padding: 5px 20px 10px 20px;">
						<input type="submit" class="submit small" value="Принять участие" style="cursor: pointer;"/> </div>
					<div style="padding: 5px 20px 10px 20px;">	<a style="text-decoration: none" href="${pageContext.request.contextPath}/pages/events/editgame/${game.idgame}">Редактировать игру</a>
