			...
			<div id="content">
				<div id="dataBlock">
					...
					<div style="background-color: #EEEFE3; border:1px solid grey; border-radius: 5px;">
						...
						<div style="width: 100%;"><div style="float: right;"><input type="submit" class="srchBtn" value="Создать" style="cursor: pointer; width: 100px; margin-top: 15px"/></div><br style="clear: both;"/></div>
					</form:form>
				</div>
