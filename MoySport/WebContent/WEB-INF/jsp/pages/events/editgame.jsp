		...
		<div id="content">
			<div id="dataBlock">
				<form:form action="${pageContext.request.contextPath}/pages/events/editgame" method="post" modelAttribute="eventgame">
					...
					<div style="padding: 5px 20px 0px 20px;"><div class="usr_tmplt_txt_l">Организатор:</div><div class="usr_tmplt_txt_r"><a href="${pageContext.request.contextPath}/pages/players/viewplayer/${creatorId}">${firstname}&nbsp;${lastname} ( your name = ${username})</a></div><div class="usr_tmplt_txt_clr"></div></div> 
